...
const DescriptionsCell: React.FC<DescriptionsCellProps> = (props) => {
  ...
  switch (type) {
    case 'label':
      return (<Component style={style} className={classnames([
        ...
        labelAlign,
        labelClassName,
      ])} colSpan={isVertical ? span : 1}>{label}</Component>)
    case 'content':
      return (<Component style={style} className={classnames([
        'el-descriptions__cell',
        ...
        align,
        className,
      ])} colSpan={isVertical ? span : span * 2 - 1}>{content}</Component>)
    default:
      return (<td style={style} className={classnames([
        'el-descriptions__cell',
        align,
      ])} colSpan={ span}>
