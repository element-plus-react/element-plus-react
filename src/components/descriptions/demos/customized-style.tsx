...
const Demo  =()=>(<Descriptions title="Customized style list" column={3} border>
    <Descriptions.Item
      label="Username"
      labelAlign="right"
      align="center"
