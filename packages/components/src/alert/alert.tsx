...
const Alert: React.FC<AlertProps> = (props) => {
  const { type = "info", closable = true, effect = "light" } = props;
      ...
      >
        ...
        <div className="el-alert__content">
          ...
          {closable && (
            <>
              {props.closeText ? (
                <div className="el-alert__closebtn is-customed" onClick={props.onClose}>
                  {props.closeText}
                </div>
              ) : (
                <CloseOutlined className="el-alert__closebtn" onClick={close} />
              )}
            </>
          )}
        </div>
