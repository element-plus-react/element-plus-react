...
const BackTop: React.FC<BackTopProps> = (props) => {
  ...
  useEventListener('scroll', handleScrollThrottled,
  ...
  return (visible ? <div style={{ right: styleRight, bottom: styleBottom }}
                         className="el-backtop" onClick={handleClick}>
      {props.children ?? <i className="el-backtop__icon"><ToTopOutlined/></i>}
    </div> : null
  )
}
